...
<nav class="pt-3 pb-3">
      ...
      <div class="row">
        <div class="col-lg-2 col-xl-2 col-xxl-4">
          <a class="navbar-brand" href="../index.php">
            <img src="<?php echo SITEURL . 'logo.svg'; ?>" alt="A1 Media" width="70" height="38">
          </a>
        </div>

        <div class="col-lg-10 col-xl-10 col-xxl-8 text-end">
          <div class="topnav pt-1">
            <a class="px-xl-2 px-1" href="<?php echo SITEURL . 'pages/who-we-are.php'; ?>">WHO WE ARE</a>
  ...
  <label for="active" class="menu-btn hidden"><i class="fas fa-bars"></i></label>
  ...
  <div class="wrapper">
    <ul class="text-center">
      <li><a class="px-xl-2 px-1" href="<?php echo SITEURL . 'pages/who-we-are.php'; ?>">WHO WE ARE</a></li>
